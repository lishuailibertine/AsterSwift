...
public struct AsterSignature{
    ...
    public static func parseSignatureHex(_ signatureHex: String) throws -> AsterSignature {
        ...
        return AsterSignature(r: "0x" + rHex, s: "0x" + sHex, v: vInt)
    }
